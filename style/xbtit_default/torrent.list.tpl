    ...
    <td>
	  ...
	  <td align="center" width="45" class="header"><tag:torrent_header_uploader /></td>
        ...
        <tr>
          ...
          <td class="lista" valign="middle" onMouseOver="this.className='post'" onMouseOut="this.className='lista'" style="padding-left:10px;overflow:auto;"><tag:torrents[].filename /><tag:torrents[].gold /></td>
          <if:WT1>
