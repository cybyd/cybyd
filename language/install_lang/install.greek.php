...
$install_lang["welcome"]                = "Καλώς ήρθατε στο installation για το νέο XBTI-Tracker.";
...
$install_lang["succes_install3"]        = "<p>Η ομάδα του BTI ελπίζει να απολάυσετε τη χρησιμοποιήση αυτού του προιόντος και να σας δούμε ξανά στο <ahref=\"http://www.btiteam.org/smf/index.php\" target=\"_blank\">forum</a>.</p>";
...
$install_lang["smf_download_b"]         = "</strong>) στο 777 και κάντε click <strong>Next</strong> για να συνεχίσετε με το install του XBTI-Tracker.<br /><br /><strong>* Και οι δύο σύνδεσμοι θα ανοίξουν σε νέο παράθυρο/tab για να αποφευχθεί το χάσιμο του install του XBTI-Tracker.</strong></p>";
...
$install_lang["succes_upgrade3"]        = "<p>WΗ ομάδα του BTI ελπίζει να απολάυσετε τη χρησιμοποιήση αυτού του προιόντος και να σας δούμε <ahref=\"http://www.btiteam.org/smf/index.php\" target=\"_blank\">forum</a>.</p>";
$install_lang['error_mysql_database']   = 'Ο installer δε μπόρεσε να έχει πρόσβαση στο &quot;<i>%s</i>&quot; database.  Με μερικούς hosts, πρέπει να δημιουργήσετε βάση δεδομένων μέσα στο administration panel πριν το xBtit το χρησιμοποιήσει.  Μερικοί ακόμη προσθέτουν prefixes - όπως το όνομα χρήστη σας - στα ονόματά σας στη βάση δεδομένων.';
